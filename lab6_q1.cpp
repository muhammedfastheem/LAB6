//function for tax rate calculation
//including library
#include<iostream>
using namespace std;
		//declaring function that obtain from the user returns value in calling variable
		...
		//function that recieves the unit,taxRate, salesTax,totaldue
